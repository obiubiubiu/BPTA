            ...
            for (int algorithmOption = 0; algorithmOption <= 9; algorithmOption++)
            {
                for (int test_taskNum = 1; test_taskNum <= 1; test_taskNum++)
                {
                    for (int test_workerNum = 1; test_workerNum <= 1; test_workerNum++)
                    {
                        ...
                        {
                            for (int test_Capacity = 0; test_Capacity <= 6; test_Capacity++)
                            {
                                for (int test_Tmax = 1; test_Tmax <= 1; test_Tmax++)
                                {
                                    for (int test_Wmax = 1; test_Wmax <= 1; test_Wmax++)
                                    {
                                        ...
                                        Basic_information info(c, speed, Number_Task * test_taskNum, Number_Worker * test_workerNum, nCapacity[test_Capacity], Wmax * test_Wmax, Tmax * test_Tmax, sati_state, dataOption);
